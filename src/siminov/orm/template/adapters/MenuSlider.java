...
public class MenuSlider extends ArrayAdapter<String> {
	...
	public View getView (int position, View convertView, ViewGroup parent) {
		...
		if(getContext() instanceof siminov.orm.template.activities.Home) {
			if(menuValue.equalsIgnoreCase(siminov.orm.template.fragments.MenuSlider.HOME_ABOUT_SIMINOV_FRAMEWORK)) {
