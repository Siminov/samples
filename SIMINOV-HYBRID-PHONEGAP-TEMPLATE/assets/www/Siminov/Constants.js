...
Constants.EVENT_HANDLER_IAUTHENTICATION_EVENT_ON_AUTHENTICATION_START = "onAuthenticationStart";

Constants.EVEVT_HANDLER_IAUTHENTICATION_EVENT_ON_AUTHENTICATION_FINISH = "onAuthenticationFinish";

Constants.EVENT_HANDLER_IAUTHENTICATION_EVENT_ON_AUTHENTICATION_TERMINATE = "onAuthenticationTerminate";
...
Constants.SIMINOV_SERVICE_ADAPTER_INVOKE_HANDLER_INLINE_RESOURCES = "INLINE_RESOURCES";


Constants.SIMINOV_SERVICE_EVENT_HANDLER = "";


//Siminov Authentication
Constants.SIMINOV_AUTHENTICATION_ADAPTER = "AUTHENTICATION";

Constants.SIMINOV_AUTHENICATION_ADAPTER_IS_ANY_ACTIVE_ACCOUNT_HANDLER = "IS-ANY-ACTIVE-ACCOUNT";
Constants.SIMINOV_AUTHENICATION_ADAPTER_GET_ACTIVE_ACCOUNT_HANDLER = "GET-ACTIVE-ACCOUNT";
Constants.SIMINOV_AUTHENTICATION_ADAPTER_GET_ACCOUNT_HANDLER = "GET-ACCOUNT";

Constants.SIMINOV_AUTHENTICATE_ADAPTER_GET_AUTHENTICATE = "GET_AUTHENTICATE";
Constants.SIMINOV_AUTHENTICATE_ADAPTER_GET_AUTHENTICATE_CREDENTIAL_PARAMETER = "CREDENTIAL";
...
Constants.SIMINOV_SYNC_ADAPTER_HANDLE_HANDLER_SYNC_REQUEST_INLINE_RESOURCES = "inlineResources";
