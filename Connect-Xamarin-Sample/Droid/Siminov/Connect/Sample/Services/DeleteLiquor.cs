...
{
	public class DeleteLiquor : Service.Service
	{
		private static readonly String SERVICE_NAME = "SIMINOV-CONNECT-LIQUORS-SERVICE";
		private static readonly String REQUEST_NAME = "DELETE-LIQUOR";

		public static readonly String LIQUOR_NAME = "LIQUOR_NAME";
