...
namespace Siminov.Core.Sample.Database
{
    public class DatabaseUtils
    {
        ...
        private void CreateBooks()
        {
            ...
            {
                Log.Log.Error(typeof(DatabaseUtils).Name, "createBooks", "DatabaseException caught while creating books, " + databaseException.GetMessage());
            }
        ...
        private void CreateCLessions(Book book)
        {
            ...
            {
                Log.Log.Error(typeof(DatabaseUtils).Name, "createCLessions", "DatabaseException caught while creating c lessions, " + databaseException.GetMessage());
            }
        }
        ...
        private void CreateCPlusLessions(Book book)
        {
            ...
            {
                Log.Log.Error(this.GetType().Name, "createCPlusLessions", "DatabaseException caught while creating c plus lessions, " + databaseException.GetMessage());
            }
        }
        ...
        private void CreateCSharpLessions(Book book)
        {
            ...
            {
                Log.Log.Error(this.GetType().Name, "createCSharpLessions", "DatabaseException caught while creating c sharp lessions, " + databaseException.GetMessage());
            }
        }
        ...
        private void CreateJavaLessions(Book book)
        {
            ...
            {
                Log.Log.Error(this.GetType().Name, "createJavaLessions", "DatabaseException caught while creating java lessions, " + databaseException.GetMessage());
            }
        }
        ...
        private void CreateJavaScriptLessions(Book book)
        {
            ...
            {
                Log.Log.Error(this.GetType().Name, "createJavaScriptLessions", "DatabaseException caught while creating javascript lessions, " + databaseException.GetMessage());
            }
        }
        ...
        private void CreateObjectiveCLessions(Book book)
        {
            ...
            {
                Log.Log.Error(this.GetType().Name, "createObjectiveCLessions", "DatabaseException caught while creating objective c lessions, " + databaseException.GetMessage());
            }
        }
        ...
        private void CreateSwiftLessions(Book book)
        {
            ...
            {
                Log.Log.Error(this.GetType().Name, "createSwiftLessions", "DatabaseException caught while creating swift lessions, " + databaseException.GetMessage());
            }
        }
    }
}
