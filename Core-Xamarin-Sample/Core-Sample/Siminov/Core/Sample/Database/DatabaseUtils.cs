...
namespace Siminov.Core.Sample.Database
{
	public class DatabaseUtils
	{
		...
		private void CreateLiquors()
		{
			...
			{
				Log.Log.Error(typeof(DatabaseUtils).Name, "createLiquors", "DatabaseException caught while creating liquors, " + databaseException.GetMessage());
			}
		...
		private void CreateGinBrands(Liquor liquor)
		{
			...
			{
				Log.Log.Error(typeof(DatabaseUtils).Name, "createGinBrands", "DatabaseException caught while creating gin brands, " + databaseException.GetMessage());
			}
		}
		...
		private void CreateRumBrands(Liquor liquor)
		{
			...
			{
				Log.Log.Error(this.GetType().Name, "createRumBrands", "DatabaseException caught while creating rumbrands, " + databaseException.GetMessage());
			}
		}
		...
		private void CreateTequilaBrands(Liquor liquor)
		{
			...
			{
				Log.Log.Error(this.GetType().Name, "createTequilaBrands", "DatabaseException caught while creating tequila brands, " + databaseException.GetMessage());
			}
		}
		...
		private void CreateVodkaBrands(Liquor liquor)
		{
			...
			{
				Log.Log.Error(this.GetType().Name, "createVodkaBrands", "DatabaseException caught while creating vodka brands, " + databaseException.GetMessage());
			}
		}
		...
		private void CreateWhiskeyBrands(Liquor liquor)
		{
			...
			{
				Log.Log.Error(this.GetType().Name, "createWhiskeyBrands", "DatabaseException caught while creating whiskey brands, " + databaseException.GetMessage());
			}
		}
		...
		private void CreateBeerBrands(Liquor liquor)
		{
			...
			{
				Log.Log.Error(this.GetType().Name, "createBeerBrands", "DatabaseException caught while creating beer brands, " + databaseException.GetMessage());
			}
		}
		...
		private void CreateWineBrands(Liquor liquor)
		{
			...
			{
				Log.Log.Error(this.GetType().Name, "createWineBrands", "DatabaseException caught while creating wines brands, " + databaseException.GetMessage());
			}
		}
	}
}
