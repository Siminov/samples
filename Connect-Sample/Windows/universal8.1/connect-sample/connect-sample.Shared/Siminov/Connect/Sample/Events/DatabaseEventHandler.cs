...
namespace Siminov.Connect.Sample.Events
{
    public class DatabaseEventHandler : IDatabaseEvents
    {
        ...
        public void OnIndexCreated(DatabaseDescriptor databaseDescriptor, EntityDescriptor entityDescriptor, Core.Model.EntityDescriptor.Index index) 
        {
        ...
        public void OnIndexDropped(DatabaseDescriptor databaseDescriptor, EntityDescriptor entityDescriptor, Core.Model.EntityDescriptor.Index index)
        {
            // TODO Auto-generated method stub
        }
    }
