...
{
    public class DeleteBook : Service.Service
    {
        private static readonly String SERVICE_NAME = "SIMINOV-CONNECT-BOOKS-SERVICE";
        private static readonly String REQUEST_NAME = "DELETE-BOOK";
