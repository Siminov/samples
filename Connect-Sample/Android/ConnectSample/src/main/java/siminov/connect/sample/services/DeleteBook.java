...
public class DeleteBook extends Service {

    private static final String SERVICE_NAME = "SIMINOV-CONNECT-BOOKS-SERVICE";
    private static final String REQUEST_NAME = "DELETE-BOOK";
