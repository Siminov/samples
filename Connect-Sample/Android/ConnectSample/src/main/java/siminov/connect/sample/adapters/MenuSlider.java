...
public class MenuSlider extends ArrayAdapter<String> {
	...
	public View getView (int position, View convertView, ViewGroup parent) {
		...
		if(getContext() instanceof siminov.connect.sample.activities.Home) {
			if(menuValue.equalsIgnoreCase(siminov.connect.sample.fragments.MenuSlider.HOME_ABOUT_SIMINOV_FRAMEWORK)) {
