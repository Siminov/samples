...
import siminov.core.sample.controllers.LiquorDetailController;
...
public class LiquorDetail extends ListFragment {
	...
	private class LoadData extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			liquor = ((siminov.core.sample.activities.LiquorDetail) getActivity()).getLiquor();
		...
		public void onPostExecute(Void params) {
			...
			setListAdapter(new siminov.core.sample.adapters.LiquorDetail(getListView().getContext(), objects.toArray()));
		}
	}
