...
import siminov.core.sample.activities.About;
...
public class MenuSlider extends ListFragment implements OnItemClickListener {
	...
	private class LoadMenu extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void params) {
			...
			if(activity instanceof siminov.core.sample.activities.Home) {
				setListAdapter(new siminov.core.sample.adapters.MenuSlider(activity, HOME_MENUS));
			}
		}
	}
