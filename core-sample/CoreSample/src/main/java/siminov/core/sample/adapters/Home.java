...
public class Home extends ArrayAdapter<Liquor> implements OnClickListener {
	...
	public void onClick(View v) {
		...
		Intent intent = new Intent(getContext(), siminov.core.sample.activities.LiquorDetail.class);
		intent.putExtra(siminov.core.sample.activities.LiquorDetail.INTENT_LIQUOR, (Liquor) getItem(v.getId()));
